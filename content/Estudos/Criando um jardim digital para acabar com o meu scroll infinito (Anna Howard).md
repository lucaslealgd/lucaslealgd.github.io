---
title: Criando um jardim digital para acabar com o meu scroll infinito
tags:
  - jardimDigital
status:
  - broto 🌿
...
A gente já sabe que ficar no celular scrollando infinitamente é algo desgastante para as pessoas
- Falamos muito sobre o problema dos conteúdos que te incentivam a comprar mas **ficar o dia inteiro no tiktok também é consumir** (consumir conteúdo, mas consumir) -> **overconsumption**
Pra sair desse padrão de overconsumption, precisamos nos **tornarmos "consumidores melhores"** e pra isso o primeiro passo é **consumir com intenção**
- É controlar o algoritmo ao invés de deixar que ele te controle
	- E também buscar por coisas fora disso, pesquisar, se interessar
	- **Busque também por pontos que contradizem as suas crenças**
		- O **algoritmo fortalece os vieses de confirmação** e está tornando as pessoas cada vez mais reativas a opiniões contrárias 
- A chave disso é fazer **anotações**
	- **Making > Consuming** (com o tempo nos tornamos melhores criadores)
Pra isso surge o <mark>Jardim Digital</mark>
- É **onde suas notas vão ser criadas**
	- Isso vai te **ajudar a desacelerar**
	- Você vai pensar um pouco sobre o que está consumindo
	- Te da um **feedback instantâneo** se você entendeu aquilo
	- Permite que você vá além e use dessa semente pra desenvolver algo
	- Cria uma **rede de informações** ao invés de uma timeline
- Essas notas terão **tags** e **links** para outras notas
	- Você vai começar a criar **conexões entre o que você consome**
	- Como se fosse uma wikipedia
- É algo em **constante construção** (nunca está pronto)
	- Entender isso permite que você não se cobre tanto
	- E é algo completamente seu
- As notas são o primeiro passo, depois disso **crie seus próprios pensamentos a partir disso**
	- Notas (base) -> **Source Material**: entender o trabalho de outra pessoa
	- **Main Notes**: criar o seu próprio conteúdo
		- é "se convidar pra conversa"
- <mark>Conceitos-chave:</mark>
	- Topografia > Timeline (o que é importa é o link entre as informações)
	- Continuamente em crescimento
	- Imperfeição e aprendizado em público
	- Pessoais, experimentais e lúdicos (tem que funcionar pra você e apenas pra você)
	- Traga referências de vários lugares e tenha uma diversidade de conteúdos 
Entenda que **faz parte você consumir** (não precisa apagar seu tiktok), mas **o importante é que você realmente "esteja ali" enquanto consome**
- Viu algo interessante? Faz uma anotação, tira algo daquilo
- Evite conteúdos que queimam seu cérebro (bloqueia mesmo) e comece a procurar pelo tipo de **consumo que faz a criatividade ser inevitável**
- Não precisa criar nota pra tudo, mas sempre tenha algo pra você escrever (nunca se sabe quando vai precisar)
# Conteúdo
Vídeo: Criando um jardim digital para acabar com o meu scroll infinito (Anna Howard)
...
![](../imagens/Conteudos/JardimDigital/AproveitarEstarQuartoPessoasLegais.png)
- **para ser mais interessante, você precisa ser mais interessado**
	- [[Ao invés de tentar ser mais interessante, tente ser mais interessado]]
...
- **Jardim Digital**
	- é um lugar para você fazer **conexões** de tudo que você está consumindo
		...
		- ![460](../imagens/Conteudos/JardimDigital/ArvoresConectadas.png)
...
- <mark>O Jardim Digital</mark>
	...
	- Depois de tomar as notas do material que você consumiu, o próximo passo é **criar seus próprios pensamentos a partir disso**, relacionando com outras notas, com suas vivências e pensamentos
...
- ![697](../imagens/Conteudos/JardimDigital/AprenderNovasCoisas.png)